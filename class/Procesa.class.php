...
class Procesa{
	...
	function __construct(){
        ...
        $this->destinatario	= "pagina.masesa@grupo-pit.com";
        $this->cc           = "";
	...
	function datos($datos){
		...
		if($grabo){
            ...
            $accion = $email->envio($this->destinatario, 'Masesa', $this->formulario, $datos);
    ...
    */
    function consultoEstado($idPais){
        ...
        $db         = new Db();
        $consulto   = $db->consultoEstado($idPais);
    ...
    /*
    *   Consulto motocicletas activas
    */
    
    function consultoMotos(){
        $db         = new Db();
        $consulto   = $db->consultoMotos();
        return  $consulto;
    }

    /*
    *   Consulto Salas de distribuidores
    */
    
    function consultoSalas($idCiudad){
        $db         = new Db();
        $consulto   = $db->consultoSalas($idCiudad);
        return  $consulto;
    }

    function consultoTalleres($idCiudad){
        $db         = new Db();
        $consulto   = $db->consultoTalleres($idCiudad);
        return  $consulto;
    }
